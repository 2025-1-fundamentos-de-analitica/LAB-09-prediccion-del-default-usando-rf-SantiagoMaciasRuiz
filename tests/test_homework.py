...
# ------------------------------------------------------------------------------
MODEL_FILENAME = "homework/files/models/model.pkl.gz"
...
def _load_grading_data():
    """Load grading data"""
    with open("homework/files/grading/x_train.pkl", "rb") as file:
        x_train = pickle.load(file)

    with open("homework/files/grading/y_train.pkl", "rb") as file:
        y_train = pickle.load(file)

    with open("homework/files/grading/x_test.pkl", "rb") as file:
        x_test = pickle.load(file)

    with open("homework/files/grading/y_test.pkl", "rb") as file:
...
def _load_metrics():
    assert os.path.exists("homework/files/output/metrics.json")
    metrics = []
    with open("homework/files/output/metrics.json", "r", encoding="utf-8") as file:
        for line in file:
